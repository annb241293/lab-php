...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="box row">
      <div class="col-md-6">
        <form action="<?php echo e(getUrl('post/edit')); ?>/<?php echo e($post->id); ?>" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label for="name">Title</label>
            <input id="name" type="text" name="name" placeholder="Nhập tên danh mục" class="form-control" value="<?php echo e($post->title); ?>">
          ...
          <div class="form-group">
            ...
            <div>
             <select class="form-control" name="category" id="category">
              ...
              <option value="<?php echo e($cate['id']); ?>" <?php echo e($post->cate_id==$cate->id?'selected':''); ?>><?php echo e($cate->cate_name); ?></option>
      ...
      <div class="form-group">
        ...
        <div>
          <textarea class="form-control" id="short_detail" name="desc"><?php echo e($post->description); ?></textarea>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div>
          <textarea rows="5" class="form-control ckeditor" id="detail" name="content"><?php echo e($post->content); ?></textarea>
        </div>
...
<?php /**PATH /opt/lampp/htdocs/php-training/lab/views/post/edit-form.blade.php ENDPATH**/ ?>
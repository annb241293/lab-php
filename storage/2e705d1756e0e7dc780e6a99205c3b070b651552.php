        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="<?php echo e(getUrl('search')); ?>" method="get">
                            <div class="form-group">
                                <div class="input-group input-group-sm">
                                    <input type="text" 
                                        value="<?php echo e(isset($_GET['keyword'])==true?$_GET['keyword']:''); ?>"    
                        ...
                        <p>Tìm thấy <?php echo e(count($post)); ?> kết quả</p>
                    </div>
                </div>
            </div>
			...
			<tr>
				...
				<td style="width: 100px">
					...
					<a href="<?php echo e(getUrl('post/remove/' . $el->id )); ?>" title="" onclick="return confirm('Are you sure?')" class="btn btn-remove btn-xs btn-danger">Xóa</a>
				</td>
...
<?php /**PATH E:\xampp\htdocs\php-training\lab\views/post/search.blade.php ENDPATH**/ ?>